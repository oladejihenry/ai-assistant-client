...
export default function Home() {
  const { createTravel, broadcastResponse } = useTravel();
          ...
          <div className="border-b border-gray-900/10 pb-12">
            <div className="col-span-full">
              <label htmlFor="about" className="block text-sm font-medium leading-6 text-gray-900">
                AI-Driven virtual travel assistant
              </label>
              <div className="mt-2">
                <textarea
                  id="message"
              ...
              <p className="mt-3 text-sm leading-6 text-gray-600">Enter details about where you want to go.</p>
            </div>
          </div>
        </div>
