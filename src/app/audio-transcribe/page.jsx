        ...
        <>
            ...
            <form onSubmit={submitForm}>
                ...
                <div className="mt-6 flex items-center justify-end gap-x-6">
                    <button
                        disabled={isSubmitting || isUploading} // Disable button if uploading
                        className={`rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm ${isSubmitting || isUploading ? 'bg-gray-400 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-500'} focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
                        type="submit"
                    >
